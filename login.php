...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('logintemplate/images/img-01.jpg');">
			<div class="wrap-login100 p-t-190 p-b-30">
				<form class="login100-form validate-form">
					<div class="login100-form-avatar">
						<img src="logintemplate/images/avatar-01.jpg" alt="AVATAR">
					</div>
...
if (isset($_GET['btn'])) {
    $e=$_GET['useremail'];
    $pass=$_GET['userpass'];
    $query=mysqli_query($con,"SELECT * FROM `registration` WHERE email='$e' and password='$pass' and role=1 ");
